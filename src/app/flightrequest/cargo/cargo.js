angular.module( 'ngBoilerplate.FlightRequestCargo', [
//    'vcRecaptcha',
    'ui.router'
])

.config(function config( $stateProvider ) {
  $stateProvider.state( 'FlightRequestCargo', {
    url: '/FlightRequestCargo',
    views: {
      "main": {
        controller: 'FlightRequest_Cargo',
        templateUrl: 'flightrequest/cargo/cargo.tpl.html'
      }
    },
...
//
//    .controller('FlightRequest_Cargo', function ($scope, vcRecaptchaService) {
...
.controller( 'FlightRequest_Cargo', function FlightRequestCargoController( $scope ) {
        var index = 0;
