angular.module( 'ngBoilerplate.servicesFuelCard', [
  'ui.router'
])

.config(function config( $stateProvider ) {
  $stateProvider.state( 'servicesFuelCard', {
    url: '/servicesFuelCard',
    views: {
      "main": {
        controller: 'services_Fuel_Card',
        templateUrl: 'services/fuel/fuelcard/fuelcard.tpl.html'
      }
    },
    data:{ pageTitle: "Request Fuel Card" }
  });
})

.controller( 'services_Fuel_Card', function services_Fuel_CardController( $scope ) {
        var index = 0;
