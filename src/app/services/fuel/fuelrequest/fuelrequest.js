angular.module( 'ngBoilerplate.servicesFuelRequest', [
  'ui.router'
])

.config(function config( $stateProvider ) {
  $stateProvider.state( 'servicesFuelRequest', {
    url: '/servicesFuelRequest',
    views: {
      "main": {
        controller: 'services_Fuel_Request',
        templateUrl: 'services/fuel/fuelrequest/fuelrequest.tpl.html'
      }
    },
    data:{ pageTitle: "Request Fuel" }
  });
})

.controller( 'services_Fuel_Request', function services_Fuel_RequestController( $scope ) {
        var index = 0;
